...
const s = StyleSheet.create({
  ...
  book: { flexDirection: 'row', gap: 2 },
  page: { width: 11, height: 20, borderWidth: 1.8 },
  leftPage: { borderTopLeftRadius: 5, borderTopRightRadius: 3, borderBottomLeftRadius: 2, transform: [{ skewY: '8deg' }] },
  rightPage: { borderTopRightRadius: 5, borderTopLeftRadius: 3, borderBottomRightRadius: 2, transform: [{ skewY: '-8deg' }] },
