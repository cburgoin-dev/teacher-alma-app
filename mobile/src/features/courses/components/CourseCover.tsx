...
const s = StyleSheet.create({
  ...
  badge: { position: 'absolute', top: 10, left: 10, backgroundColor: '#0056CE', borderRadius: 11, paddingHorizontal: 9, paddingVertical: 4, maxWidth: '85%' },
  level: { fontSize: 15, lineHeight: 20, fontWeight: '800', color: '#FFF' },
  heroBadge: { top: 14, left: 14, borderRadius: 14, paddingHorizontal: 12, paddingVertical: 6 },
  heroLevel: { fontSize: 19, lineHeight: 25 },
  captionShade: { position: 'absolute', bottom: -3, left: -3, right: -3, backgroundColor: '#004BA9B8', padding: 12, paddingBottom: 16, borderTopRightRadius: 32, transform: [{ rotate: '-3deg' }] },
  caption: { color: colors.white, fontSize: 14, lineHeight: 17, fontWeight: '800', fontStyle: 'italic', textShadowColor: '#003772', textShadowRadius: 3, textShadowOffset: { width: 0, height: 1 } },
