...
test('demo media serves exact fixture bytes and audio ranges only in development', async () => {
  for (const environment of ['development', 'production']) {
    ...
    try {
      ...
      for (const name of ['greeting.png', 'greeting-hello-v8.png', 'greeting-hello-v9.png', 'greeting-wave-v10.png', 'greeting-response-v10.png', 'ball.png', 'nice-to-meet-you.wav', 'sofia-greeting.wav', 'daniel-greeting.wav', 'daniel-intro.wav', 'nice-to-meet-you-too.wav', 'i-am-a-student.wav', 'it-is-a-book.wav']) {
