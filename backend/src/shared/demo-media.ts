...
export function demoMedia(environment: string | undefined) {
  ...
  for (const name of ['greeting.png', 'greeting-hello-v8.png', 'greeting-hello-v9.png', 'greeting-wave-v10.png', 'greeting-response-v10.png', 'nice-to-meet-you.wav', 'sofia-greeting.wav', 'daniel-greeting.wav', 'daniel-intro.wav', 'nice-to-meet-you-too.wav', 'i-am-a-student.wav', 'it-is-a-book.wav', 'ball.png']) {
